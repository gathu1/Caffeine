...
function About() {
  return (
      <div style={{ backgroundColor: 'grey', backgroundImage: 'url(/src/Images.jpg)', backgroundSize: 'cover' }}>

        <h1 style={{ fontSize: '2.5rem', textAlign: "center", fontWeight: 'bold' }}>About Us</h1>
        <ul style={{ fontSize: '1.1rem', listStyleType: 'disc', paddingLeft: '1.5rem', lineHeight: '2rem' }}>
        <li>
